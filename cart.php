    ...
    <div class="cart-container">
        ...
        <?php
            ...
            if (isset($_SESSION['customer_id'])){
                ...
                $sql="SELECT cart.cart_id, cart.product_id, product.product_name, product.product_price, product.product_weight, min(product_img.image) AS min_image FROM cart JOIN product ON cart.product_id= product.product_id JOIN product_img ON cart.product_id =  product_img.product_id WHERE cart.customer_id = $customer_id GROUP BY cart.cart_id, cart.product_id, product.product_name, product.product_price, product.product_weight";
