...
<head>
    ...
    <link rel="stylesheet" href="viewUnvailableProducts.css">
...
<body>
    ...
    <div class="card">
        <p onclick="window.location.href='viewAvailableProducts.php'">Display all <span class="available">available</span> products</p>
        <span class="material-symbols-outlined">event_available</span>
    </div>

    <!-- card to show all unavailable products -->
    <div class="card">
        <p onclick="window.location.href='viewUnvailableProducts.php'"> Display all <span class="unavailable">unavailable</span> products </p>
        <span class="material-symbols-outlined">event_busy</span>
    </div>
    
    <div class="container-fluid">
    <h2 class="table-header">View Unvailable Products</h2>
    ...
    <table>
        ...
        WHERE p.product_status='unavailable'
