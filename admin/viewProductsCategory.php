        ...
        <table>
            ...
            if ($result->num_rows > 0) 
            {
                ...
                while ($row = $result->fetch_assoc()) 
                {
                    ...
                    echo "<td>";
                    echo "<button class='actionBtn' onclick='editCat(" . $row['category_id'] . ", \"" . $row['category_name'] . "\")'>Edit</button>";
    ...
    <div id="editOverlay" class="overlay">
        <div class="overlay-content">
            ...
            <form id="editForm" method="POST" action="updateTypeCat.php">
                <label for="editCatId">Type ID:</label>
                <input type="text" id="catId" name="catId" readonly>

                <label for="editCatName">Type Name:</label>
                <input type="text" id="catName" name="catName" class="">
