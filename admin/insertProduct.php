...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($insertProductSQL) === TRUE) {
        ...
        for ($i = 0; $i < min($maxFiles, count($_FILES['pimages']['name'])); $i++) {
        ...
        // <div class="notification-title">Add New Product Notice</div>
        // <hr class="brown-line">
        // <div class="notification-message">Product has been added!</div>
        // </div>';
