    ...
    <script>
        function confirmDelete(deleteRequestId) {
            ...
            if (confirmDelete) {
                ...
                xhr.open('DELETE', 'delete-request.php?request_id=' + deleteRequestId, true);
                ...
                if (xhr.status === 200) {
                    ...
                    alert('Failed to delete entry. Status: ' + xhr.status);
                }
            };
        ...
        function viewRequest(requestData) {
                ...
                if (this.readyState == 4) {
                    if (this.status == 200) {
                        ...
                        for (var i = 0; i < images.length; i++) {
                            ...
                            imgElement.src = "data:image/jpeg;base64," + images[i].textContent;
            ...
            xhr.open("GET", "request-img.php?request_id=" + requestId, true);
            xhr.send();
        }
